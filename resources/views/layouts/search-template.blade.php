            ...
            <div class="col-md-20">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <form id="search_form_1" action="/event/search" method="GET" enctype="multipart/form-data">
                            ...
                            <div class="startTimeBox" style="margin-left: 15px; display: inline-block; ">
                                <input  type="text" name="startDate" class="datepicker form-control check-value" id="startDateBox" placeholder="開始日期" >
                            </div>
                            <span>&nbsp;到&nbsp;</span>
                            <div class="endTimeBox" style="display: inline-block; border: none; border-radius: 6px; ">
                                <input  type="text" name="endDate" class="datepicker form-control check-value" id="endDateBox" placeholder="結束日期" >
                            </div>
                            ...
                            <div class="searchBox" style="margin:0; display: inline-block; ">
                                <input type="text" name="eventName" class="searchName form-control check-value" placeholder="活動名稱"  style="padding-left: 25px">
                            </div>
                        ...
                        <form id="search_form_2" action="/event/search" method="GET" enctype="multipart/form-data" style="display: none">
                            ...
                            <div class="dropdown" style="display: inline-block">
                                ...
                                <input type="hidden" name="group-location" >
                            </div>
                            ...
                            <div class="searchBox" style="margin-left: 15px; display: inline-block; border: none; border-radius: 6px; ">
                                <input type="text" name="groupName" class="searchName form-control" placeholder="組織名稱"  style="padding-left: 25px">
                            </div>
