...
class similarityCalculationEventToEventJob implements ShouldQueue
{
    ...
    public function __construct(int $event_id)
    {
        ...
        $this->similarity_calculation_job_record = SimilarityCalculationJobRecord::create([
                'pass_id' => $event_id,
                'type' => SimilarityCalculationJobRecord::EVENT_TO_EVENT_TYPE,
    ...
    public function handle()
    {
        ...
        $this->similarityCalculation_event_to_event($this->event_id);
