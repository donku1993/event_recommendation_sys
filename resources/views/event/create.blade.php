                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form id="registration-form-event" enctype="multipart/form-data">
                            ...
                            <fieldset>
                                <h2 class="stepTitle">第一步: 填寫活動基本資料</h2>
                                <div class="panel panel-primary">
                                <div class="panel-heading">加入活動標題</div>
                                <div class="panel-body">
                                    <input type="text" name="title" class="check-value form-control"  id="title" placeholder="請輸入標題">
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    ...
                                    <input  type="text" id="startDateBox" name="startDate" class="check-value datepicker form-control">
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-danger">
                                ...
                                <div class="panel-body">
                                    ...
                                    <input type="text" name="endDate" id="endDateBox" class="check-value datepicker form-control" >
                                    <br>
                                </div>
                            </div>
                            ...
                            <br><br>
                                ...
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <input type="text" name="signUpEndDate" id="signUpEndDateBox" class="check-value datepicker form-control">
                                        <br>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-warning">
                                ...
                                <div class="panel-body">
                                    <input type="number" min="1" id="numPeople" name="numberOfPeople" class="check-value form-control" placeholder="請輸入人數" >
                                </div>
                            </div>
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    <textarea  class="check-value summernote" id="content" name="content"></textarea>
                                </div>
                            </div>
                                ...
                                <div class="panel panel-warning">
                                    ...
                                    <div class="panel-body">
                                        <textarea  class="check-value summernote" id="schedule" name="schedule"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-danger">
                                    ...
                                    <div class="panel-body">
                                        <textarea  class="check-value summernote" id="requirement" name="requirement"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <textarea  class="check-value summernote" id="remark" name="remark"></textarea>
                                    </div>
                                </div>
